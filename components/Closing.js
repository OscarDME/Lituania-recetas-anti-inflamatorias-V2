...
const BASE_CHECKOUT_URL = "https://www.oriopay.app/p/priesuzdegiminiai-receptai-v2";
      ...
      <section className="w-full bg-[#fffdf7] py-14 md:py-20 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 text-center border border-gray-100">
            ...
            <div className="mt-6">
              <img
                src="/Logos-garantia-sin-fondo/Lituania-garantia.webp"
